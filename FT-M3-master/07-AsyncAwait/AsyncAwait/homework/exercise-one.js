...
async function problemB () {
  ...
  // AsyncAwait version
  let stz2 = await promisifiedReadFile("poem-one/stanza-02.txt")
  blue(stz2)
  let stz3 = await promisifiedReadFile("poem-one/stanza-03.txt")
  blue(stz3)
...
async function problemD () {
  ...
  // AsyncAwait version
  try {
    let stz4 = await promisifiedReadFile("poem-one/wrong-file-name.txt")
    blue(stz4)
  } catch (error) {
    magenta(error)
  }
