...
async function problemA() {
  ...
  // AsyncAwait version
  await Promise.all([
    readSyncFile("poem-two/stanza-01.txt"),
    readSyncFile("poem-two/stanza-02.txt"),
  ]);
  console.log("done");
}
...
async function problemB() {
  ...
  // AsyncAwait version
  await Promise.all(filenames.map(readSyncFile));
  console.log("done");
}
