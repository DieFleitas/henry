...
function problemA() {
  ...
  // promise version
  promisifiedReadFile("poem-one/stanza-01.txt").then((stz1) => {
    blue(stz1);
  });
}
...
function problemB() {
  ...
  // promise version
  promisifiedReadFile("poem-one/stanza-02.txt").then((stz2) => {
    blue(stz2);
  });
  promisifiedReadFile("poem-one/stanza-03.txt").then((stz3) => {
    blue(stz3);
  });
}
...
function problemC() {
  ...
  promisifiedReadFile("poem-one/stanza-02.txt").then((stz2) => {
    blue(stz2);
    return promisifiedReadFile("poem-one/stanza-03.txt").then((stz3) => {
      blue(stz3);
    });
  });
}
